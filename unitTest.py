...
props = ["apce_4.1x4.1","apc_10x8","apcepn_20.5x13.5"]
motors = ["dys BX1306-3100","Actro 12-4","Astro Cobalt 90 11T#23 #690"]
batteries = ["Turnigy 1000mAH 25C LiPo","Hacker TopFuel EcoX 2400mAh","SLS-APL 5000 45C"]
numCells = 3
escs = ["Kontronic SUN 3000","Ace Smart Throttle","Astro 211"]
altitude = 2000
thrusts = [0.05,0.3,0.2]
speeds = [5,15,20]
